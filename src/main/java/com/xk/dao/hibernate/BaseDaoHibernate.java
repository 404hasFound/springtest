...
public class BaseDaoHibernate<T, ID extends Serializable> {
    ...
    @Resource
    protected SessionFactory authsessionFactory;
    ...
    public void save(final T entity) {
        ...
        authsessionFactory.getCurrentSession().save(entity);
        logger.debug("save entity: {}", entity);
    }

    public void saveOrUpdate(final T entity) {
        Validate.notNull(entity, "entity不能为空");
        authsessionFactory.getCurrentSession().saveOrUpdate(entity);
        logger.debug("save entity: {}", entity);
    }
    ...
    public void delete(final T entity) {
        Validate.notNull(entity, "entity不能为空");
        authsessionFactory.getCurrentSession().delete(entity);
    ...
    public T get(final ID id) {
        Validate.notNull(id, "id不能为空");
        return (T) authsessionFactory.getCurrentSession().load(entityClass, id);
    }
    ...
    public Query createQuery(final String queryString, final Object... values) {
        ...
        Query query = authsessionFactory.getCurrentSession().createQuery(queryString);
        if (values != null) {
    ...
    public SQLQuery createSQLQuery(String queryString, String[] field, Type[] fieldtype,
       ...
       //SQLQuery query = authsessionFactory.getCurrentSession().createSQLQuery(queryString);
        session = authsessionFactory.openSession();
    ...
    public List<T> find(DetachedCriteria detachedCriteria) {
        Criteria criteria = detachedCriteria.getExecutableCriteria(authsessionFactory
                .getCurrentSession());
    ...
    public Criteria createCriteria(final Criterion... criterions) {
        Criteria criteria = authsessionFactory.getCurrentSession().createCriteria(entityClass);
     ...
     */
    public void flush() {
        authsessionFactory.getCurrentSession().flush();
    }
    ...
    public String getIdName() {
        ClassMetadata meta = authsessionFactory.getClassMetadata(entityClass);
